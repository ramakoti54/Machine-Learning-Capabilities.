...
class N_Model:
   def Web_scrapping(self, URL,Content):
      with urs.urlopen(URL):
...
URL = "https://finance.yahoo.com/news/july-rate-cut-from-fed-is-now-completely-off-the-table-following-solid-jobs-report-141432543.html";
#Token_Value = 1;
#Vector = [];
Content = "";
#Tokens = [];
